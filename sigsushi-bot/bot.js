...
const CONFIG = {
    // Substitua pelo link do seu cardápio digital
    MENU_URL: 'https://seurestaurante.com.br/cardapio',
    
    // Nome do seu restaurante
    RESTAURANT_NAME: 'Seu Restaurante',
    
    // Mensagem de boas-vindas personalizada
    WELCOME_MESSAGE: `Olá! 🍕 Bem-vindo(a) ao *Seu Restaurante*! 
...
Obrigado por escolher o *Seu Restaurante*! ❤️`
};
